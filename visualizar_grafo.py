...
def main():
    parser = argparse.ArgumentParser(
        description="Gera imagem do grafo de distância com labels de nós e pesos."
    )
    parser.add_argument(
        "--csv",
    ...
    parser.add_argument(
        ...
        default="min_cross",
        help="Layout: min_cross minimiza cruzamentos num layout comum; os restantes calculam um layout automático.",
    )
    parser.add_argument(
        "--quiet",
        action="store_true",
    ...
    grafo_distancia = build_grafo(args.csv, args.weight_col, undirected=True)
    graph = build_graph(grafo_distancia)
